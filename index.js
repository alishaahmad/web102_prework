...
function filterUnfundedOnly() {
  ...
  // console.log("Unfunded games:", unfunded.length, unfunded);
...
function filterFundedOnly() {
  ...
  // console.log("Funded games:", funded.length, funded);
...
// count unfunded and add summary text with correct grammar
...
descriptionElement.textContent = descriptionStr.trim();
...
// sort by pledged (desc) — slice() to avoid mutating original if you want
const sortedGames = [...GAMES_JSON].sort((a, b) => b.pledged - a.pledged);

// destructure top two
const [topGame, runnerUp] = sortedGames;

// create and append elements for top two
const firstTitle = document.createElement("h4");
firstTitle.textContent = topGame.name;
firstGameContainer.appendChild(firstTitle);

const secondTitle = document.createElement("h4");
secondTitle.textContent = runnerUp.name;
